...
##############################################################################
#                                                         					 #
# SCRIPT NUTANIX TOOLS FOR AHV v1.3                                          #
# PYTHON 3.6                                                                 #
...
version_soft = 'Nutanix tools for AHV v1.3' 
print(version_soft)
    ...
    for vm in entities:  ### VM WITH NIC
    	for nic in vm[4]:
            ...
            if confirm == 'y':
            	...
            	if 'metadata' in pc_vm_single_raw:
            		metadata = 100
            		if 'project_reference' in pc_vm_single_raw['metadata']:
