#!/usr/bin/env python3
##############################################################################
# SCRIPT NUTANIX TOOLS FOR AHV v1.7.7                                        #
# PYTHON 3.6                                                                 #
...
version_soft = 'Nutanix tools for AHV v1.7.7'
print(version_soft)
start = time.time()
...
if pe_success_login == 100:
    ...
    worksheet0.write('A29', 'DATE',bold_0)
    worksheet0.write('A30', 'VERSION SCRIPT TOOLS',bold_0)
    ...
    while exit is 0:
        for storagepool_raw in storagepool:
            ...
            if counter is not 0:
                ...
                worksheet11.merge_range('C2'+':C'+str(POOLEN+1),'='+(str(CAPACITY))+'/1024/1024/1024/1024', bold2)
    ...
    worksheet0.write(row + 28, 1, today.strftime('Running on %d, %b %Y'), boldcell)
    worksheet0.write(row + 29, 1, version_soft, boldcell)
